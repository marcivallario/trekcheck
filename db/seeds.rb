...
flight4 = Flight.create(leg: 'outbound', airline: 'Southwest Airlines', flight_no: 'WN5840', dep_airport: 'MCO', dep_time: DateTime.new(2022,3,8,4,30), arr_airport: 'LGA', arr_time: DateTime.new(2022,3,8,7,35), seat: '3C', confirmation: '49HYY7', notes: 'One-Way, internet on board', trip_id: trip1.id)
